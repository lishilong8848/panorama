                    ...
                    if repairable_crash:
                        ...
                        with self._lock:
                            ...
                            if bool(worker_result.get("cancelled", False)) or force_killed:
                                ...
                                (return_code != 0 and not stdout_shutdown_artifact)
                                or not worker_result
                                or not bool(worker_result.get("ok", False))
                            ):
                                detail = (
                                ...
                                stage.finished_at = job.finished_at
                                failure_status = self._job_failure_status(job)
                                if failure_status:
                                    detail = self._job_failure_detail(job)
