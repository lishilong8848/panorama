...
def present_internal_source_cache_overview(payload: Any) -> Dict[str, Any]:
    ...
    branch_current_bucket = _string(source_cache.get("branch_current_family", {}).get("current_bucket", "")) or branch_power_bucket
    ...
    chiller_mode_switch_family = present_source_cache_family(
        ...
        title="制冷单元模式切换参数源文件",
        fallback_bucket=chiller_mode_switch_bucket,
        bucket_scope_text="本次定时",
    )
    families = [
        handover_family,
