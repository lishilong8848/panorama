...
def adapt_runtime_config(v3_cfg: Dict[str, Any]) -> Dict[str, Any]:
    ...
    temperature_humidity_upload = _dict(features.get("temperature_humidity_upload"))
    system_screenshot_upload = _dict(features.get("system_screenshot_upload"))
    ...
    runtime = {
        ...
        "temperature_humidity_upload": copy.deepcopy(temperature_humidity_upload),
        "system_screenshot_upload": copy.deepcopy(system_screenshot_upload),
...
def sync_runtime_back_to_v3(v3_cfg: Dict[str, Any], runtime_cfg: Dict[str, Any]) -> Dict[str, Any]:
    ...
    monthly_upload = _dict(monthly.get("upload"))
    if isinstance(runtime_feishu.get("local_mysql"), dict):
        monthly_upload["local_mysql"] = copy.deepcopy(runtime_feishu["local_mysql"])
    ...
    features["temperature_humidity_upload"] = deep_merge_defaults(
        _dict(runtime.get("temperature_humidity_upload")),
        _dict(features.get("temperature_humidity_upload")),
    )
    features["system_screenshot_upload"] = deep_merge_defaults(
