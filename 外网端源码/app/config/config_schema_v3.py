    ...
    "features": {
        ...
        "handover_log": {
            ...
            "scheduler": {
                ...
                "cloud_catchup_enabled": True,
                "cloud_catchup_morning_time": "08:00:00",
                "cloud_catchup_afternoon_time": "17:30:00",
                "check_interval_sec": 30,
                "catch_up_if_missed": False,
                ...
                "cloud_catchup_morning_state_file": "handover_cloud_catchup_morning_state.json",
                "cloud_catchup_afternoon_state_file": "handover_cloud_catchup_afternoon_state.json",
            },
            "download": {
        ...
        "branch_power_upload": {
            ...
            "power_alert_sync": {
                ...
                "tables": {
                    ...
                    "branch": {
                        "name": "单支路超6.25KW功率",
                        "table_id": "tblvyOhLPCIH52gB",
                        "view_id": "vewcScal5R",
                        "threshold": 6.25,
                    },
                    "cabinet": {
                        "name": "机柜超18KW统计",
                        "table_id": "tbloY4JDihNu0aJ7",
                        "view_id": "vewjNHFVZK",
                        "threshold": 18,
                    },
                    "line_head": {
                        "name": "列头柜超107.5功率统计",
                        "table_id": "tblqxn3BajmZHxb6",
                        "view_id": "vew07sLZm1",
                        "threshold": 107.5,
                    },
                    "row_line": {
                        "name": "机列超215KW功率统计",
                        "table_id": "tblCcFzmKKz50tYT",
                        "view_id": "vewQialYnD",
                        "threshold": 215,
                    },
                },
        ...
        "temperature_humidity_upload": {
            ...
            "scheduler": {
                ...
                "catch_up_if_missed": True,
                "retry_failed_in_same_period": True,
                "state_file": "temperature_humidity_upload_scheduler_state.json",
            },
            "target": {
                "app_token": "ASLxbfESPahdTKs0A9NccgbrnXc",
