...
def _runtime_payload(container) -> Dict[str, Any]:
    ...
    return {
        ...
        "last_published_commit": str(runtime.get("last_published_commit", "") or ""),
        "last_publish_attempt_commit": str(runtime.get("last_publish_attempt_commit", "") or ""),
        "last_publish_deferred_commit": str(runtime.get("last_publish_deferred_commit", "") or ""),
        "last_publish_command_id": str(runtime.get("last_publish_command_id", "") or ""),
        "last_internal_apply_completed_commit": str(runtime.get("last_internal_apply_completed_commit", "") or ""),
        "last_internal_apply_failed_commit": str(runtime.get("last_internal_apply_failed_commit", "") or ""),
