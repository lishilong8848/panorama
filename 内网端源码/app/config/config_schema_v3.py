...
DEFAULT_CONFIG_V3: Dict[str, Any] = {
    ...
    "features": {
        ...
        "handover_log": {
            ...
            "building_full_cabinet_power": {
                "download": {
                    "template_name": "楼栋全机柜功率",
                    "sheet_name": "",
                    "scale_label": "小时",
                    "menu_path": ["报表报告", "数据查询", "即时报表"],
                    "export_button_text": "原样导出",
                    "query_result_timeout_ms": 180000,
                    "page_refresh_retry_count": 2,
                },
            },
            "capacity_report": {
                "download": {
        ...
        "alarm_rule_export": {
            ...
            "parallel": 5,
            "download_root": "",
            "state_file": ".runtime\\alarm_rule_export\\export_records.json",
            "screenshots_dir": ".runtime\\alarm_rule_export\\screenshots",
            "generate_poll_interval_sec": 86400,
            "export_generate_timeout_ms": 172800000,
            "keep_open_sec": 1,
            "headless": False,
            "scheduler": {
                "enabled": True,
                ...
                "retry_failed_in_same_period": True,
                "retry_interval_sec": 86400,
                "state_file": "alarm_rule_export_scheduler_state.json",
            },
        },
        "system_screenshot_capture": {
            "enabled": True,
            "site_building": "A楼",
            "download_root": "",
            "state_file": ".runtime\\system_screenshot_capture\\capture_records.json",
            "headless": False,
            "keep_open_sec": 1,
            "viewport_width": 1920,
            ...
            "login_detect_timeout_ms": 5000,
            "action_timeout_ms": 10000,
            "menu_timeout_ms": 20000,
            "network_idle_timeout_ms": 12000,
            "browser_resource_wait_sec": 300,
            "targets": [
                {
